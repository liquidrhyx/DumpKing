...
# Static fields for freeze functionality
...
.method public static processCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Ljava/lang/String;->startsWith(Ljava/lang/String;)Z
    move-result v1
    if-eqz v1, :check_searchhex
    invoke-static {}, Lcom/spy/MemorySpy;->handleUnfreeze()Ljava/lang/String;
    move-result-object v0
    return-object v0
    
    :check_searchhex
    # SEARCHHEX:hexpattern
    const-string v0, "SEARCHHEX:"
    invoke-virtual {p0, v0}, Ljava/lang/String;->startsWith(Ljava/lang/String;)Z
    move-result v1
    if-eqz v1, :check_maps
    invoke-static {p0}, Lcom/spy/MemorySpy;->handleSearchHex(Ljava/lang/String;)Ljava/lang/String;
    move-result-object v0
    return-object v0
...
.method public static handleSearchHex(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    
    const-string v0, "SEARCHHEX_NOT_IMPLEMENTED"
    return-object v0
.end method
